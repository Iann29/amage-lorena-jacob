      ...
      <div className="container mx-auto pt-14 pb-10">
        <div className="pb-12 relative">
          ...
          <div className="md:grid md:grid-cols-12 px-6 md:px-0">
            ...
            {/* Separador vertical */}
            <div className="hidden md:block md:col-span-1 h-auto w-px bg-gray-200 mx-auto"></div>
            ...
            <div className="flex flex-col md:flex-row md:justify-end md:col-span-8 lg:col-span-7 space-x-0 md:space-x-10 lg:space-x-16 pl-0">
              ...
              <div className="mb-8 md:mb-0 md:w-auto" style={{maxWidth: "200px"}}>
                ...
                <ul className="text-[#6E6B46] space-y-3 text-xs font-['Poppins']">
                  ...
                  <li>
                    <Link href="/#palestras" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> Palestras & Consultorias
                    </Link>
                  </li>
                  <li>
                    <Link href="/#ebook" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> E-book Rotina Diária
                    </Link>
                  </li>
                  <li>
                    <Link href="/#depoimentos" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> Depoimentos
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-8 md:mb-0 md:w-auto" style={{maxWidth: "200px"}}>
                ...
                <ul className="text-[#6E6B46] space-y-3 text-xs font-['Poppins']">
                  ...
                  <li>
                    <Link href="/sobre#portfolio" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> Meu portfólio
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-8 md:mb-0 md:w-auto" style={{maxWidth: "200px"}}>
                ...
                <ul className="text-[#6E6B46] space-y-3 text-xs font-['Poppins']">
                  ...
                  <li>
                    <Link href="/blog/categoria/rotina" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> Como criar uma rotina estruturada para crianças
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-8 md:mb-0 md:w-auto" style={{maxWidth: "200px"}}>
                ...
                <ul className="text-[#6E6B46] space-y-3 text-xs font-['Poppins']">
                  ...
                  <li>
                    <Link href="/loja/categoria/jogos" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> Jogos
                    </Link>
                  </li>
                  <li>
                    <Link href="/loja/categoria/brinquedos-montessorianos" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> Brinquedos Montessorianos
                    </Link>
                  </li>
                  <li>
                    <Link href="/loja/categoria/pecs" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> PECS & Comunicação Alternativa
                    </Link>
                  </li>
                  <li>
                    <Link href="/loja/categoria/ebooks" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> E-BOOKS
                    </Link>
                  </li>
                  <li>
                    <Link href="/loja/categoria/materiais" className="hover:text-[#52A4DB] transition-colors duration-200 flex items-center">
                      <span className="mr-2">•</span> Materiais Pedagógicos
                    </Link>
                  </li>
                </ul>
              </div>
      ...
      <div className="bg-[#CFCFCF] py-8">
        <div className="container mx-auto px-6 md:px-0">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <h4 className="text-[#6E6B46] font-bold text-sm uppercase tracking-wide mb-4 font-['Poppins']">SIGA-ME NAS REDES</h4>
              <div className="flex space-x-6">
                <motion.a 
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#888888" className="bi bi-facebook" viewBox="0 0 16 16">
                ...
                <motion.a 
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#888888" className="bi bi-instagram" viewBox="0 0 16 16">
            ...
            >
              <h4 className="text-[#6E6B46] font-bold text-sm uppercase tracking-wide mb-4 font-['Poppins']">FORMAS DE PAGAMENTO</h4>
      ...
      <div className="container mx-auto pt-8 pb-4 px-6 md:px-0">
        <div className="flex flex-col md:flex-row justify-center md:justify-between items-center text-xs text-[#6E6B46] font-['Poppins']">
          <div className="mb-3 md:mb-0 flex space-x-8">
            ...
            <Link href="/politicas-de-privacidade" className="hover:text-[#52A4DB] transition-colors duration-200">

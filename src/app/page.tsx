        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="mb-8 md:mb-0 md:w-1/2">
              <h2 className="text-4xl md:text-6xl mb-0 md:mb-2 text-center md:text-left" style={{ color: '#0B5394', fontWeight: 500, fontFamily: 'var(--font-museo-sans)' }}>SIGA-ME NAS</h2>
              <h2 className="text-4xl md:text-7xl font-bold mb-6 text-center md:text-left" style={{ color: '#0B5394', fontFamily: 'var(--font-museo-sans)' }}>REDES SOCIAIS</h2>
          ...
          <p className="text-2xl md:text-3xl mb-8" style={{ color: '#0B5394', fontWeight: 500, fontFamily: 'var(--font-museo-sans)' }}>/@lorenajacob.st</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mx-auto max-w-sm md:hidden mt-6">
          {instagramPostsData.slice(0, 4).map((post, index) => (
            ...
            >
              ...
              <div className="flex justify-center md:justify-start md:ml-5 mt-10">
                <a href="https://instagram.com/lorenajacob.st" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-8 py-4 md:px-10 md:py-5 rounded-lg text-white transition-all duration-300 transform hover:scale-105 hover:shadow-lg" style={{ backgroundColor: '#0B5394', color: 'white', fontWeight: 500, fontFamily: 'var(--font-museo-sans)' }}>
                  <svg className="w-6 h-6 md:w-8 md:h-8 mr-3" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/>
                  </svg>
                  <span className="text-3xl md:text-4xl" style={{ fontWeight: 500 }}>SIGA O MEU PERFIL</span>
                </a>
              </div>
            </div>

        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="mb-8 md:mb-0 md:w-1/2">
              <h2 className="text-5xl mb-2" style={{ color: '#0B5394', fontWeight: 500, fontFamily: 'var(--font-museo-sans)' }}>SIGA-ME NAS</h2>
              <h2 className="text-6xl font-bold mb-4" style={{ color: '#0B5394', fontFamily: 'var(--font-museo-sans)' }}>REDES SOCIAIS</h2>
          ...
          <p className="text-xl mb-6" style={{ color: '#0B5394', fontWeight: 500, fontFamily: 'var(--font-museo-sans)' }}>/@lorenajacob.st</p>
              ...
              <a href="https://instagram.com/lorenajacob.st" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 rounded-lg text-white transition-all duration-300 mt-8 transform hover:scale-105 hover:shadow-lg" style={{ backgroundColor: '#0B5394', color: 'white', fontWeight: 500, marginLeft: '20px', fontFamily: 'var(--font-museo-sans)' }}>

            ...
            <div className="p-4 flex flex-col h-full">
              ...
              <nav className="flex-1">
                  <ul className="space-y-2">
                      ...
                      {/* E-commerce */}
                      {isSidebarOpen && <li className="pt-3 pb-1"><span className="text-xs font-semibold text-gray-400 uppercase tracking-wider px-3">E-commerce</span></li>}
                      <li> <Link href="/admin/produtos" className={`flex items-center p-3 text-gray-700 rounded-lg hover:bg-purple-50 hover:text-purple-700 transition-all ${pathname.startsWith('/admin/produtos') ? 'bg-purple-100 text-purple-800' : ''}`}> <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg> {isSidebarOpen && <span className="ml-3">Produtos</span>} </Link> </li>
                      <li> <Link href="/admin/pedidos" className={`flex items-center p-3 text-gray-700 rounded-lg hover:bg-purple-50 hover:text-purple-700 transition-all ${pathname.startsWith('/admin/pedidos') ? 'bg-purple-100 text-purple-800' : ''}`}> <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg> {isSidebarOpen && <span className="ml-3">Pedidos</span>} </Link> </li>
                      <li> <Link href="/admin/clientes" className={`flex items-center p-3 text-gray-700 rounded-lg hover:bg-purple-50 hover:text-purple-700 transition-all ${pathname.startsWith('/admin/clientes') ? 'bg-purple-100 text-purple-800' : ''}`}> <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg> {isSidebarOpen && <span className="ml-3">Clientes</span>} </Link> </li>
                      
                      {/* Conteúdo */}
                      {isSidebarOpen && <li className="pt-3 pb-1"><span className="text-xs font-semibold text-gray-400 uppercase tracking-wider px-3">Conteúdo</span></li>}
